...
public class AlienTwo extends BorderPane {
	private String name;
	private boolean hit;
	...
	public AlienTwo(Double xCord, Double yCord, LaserShotCollection activeShots) {
		this.name = "Alien Two";
		this.hit = false;
		this.points = 20;
		this.yCord = yCord;
		this.xCord = xCord;
		this.imagePath = "File:" + "alien2.png";
	...
	public double move(double d) {
		...
		if (xCord <= -2000 || xCord >= 2000) { // Assuming the canvas width is 1000 and alien width is 50
